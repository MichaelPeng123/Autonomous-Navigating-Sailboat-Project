/* LSM303 Calibration
7/5/2014 Diane Brancazio www.robosail.org dianemarie@alum.mit.edu
/* Use this code to calibrate the compass sensor 
by finding the min and max readings on teh x,y, sensors.
Slowly spin the sensor a few times around, then check the 
serial monitor for the lows and highs.  
Map to range -100 to +100 in BoatCode
*/
